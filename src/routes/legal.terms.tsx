...
export const Route = createFileRoute("/legal/terms")({
  ...
  component: () => (
    ...
    >
      ...
      <p>
        See the{" "}
        <a className="underline" href="/legal/prohibited">
          prohibited items policy
        </a>
        . Listings that violate it are removed and sellers banned.
      </p>
      ...
      <p>
        ...
        by default; cash-back to the original method is available on request and subject to a small
        processing fee.
      </p>
      <h2>5. Disputes</h2>
      <p>
