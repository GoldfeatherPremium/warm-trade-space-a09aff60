...
export const Route = createFileRoute("/legal/escrow")({
  ...
  component: () => (
    <LegalPage title="How escrow works" intro="Money sits with X-VAULT — not the seller — until delivery passes warranty.">
      <h2>1. Buyer pays</h2>
      <p>Funds (USDT or store credit) land in escrow the moment payment is confirmed.</p>
      <h2>2. Seller delivers</h2>
      <p>Auto-delivery products release stock instantly. Manual products are delivered through the order chat.</p>
      ...
      <p>
        Either party can open a dispute. Funds stay frozen until staff rule based on the order snapshot,
        chat log and uploaded proof.
      </p>
      <h2>5. Payout</h2>
      <p>Released escrow becomes available wallet balance. Sellers withdraw to USDT after a small network fee.</p>
    </LegalPage>
  ),
});
