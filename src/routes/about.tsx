...
export const Route = createFileRoute("/about")({
  ...
  component: () => (
    ...
    >
      <h2>What we do</h2>
      <p>
        Buyers pay into escrow. Sellers deliver. Funds release only when delivery passes the
        warranty window and the buyer confirms. Every step is logged so disputes resolve on facts,
        not opinions.
      </p>
