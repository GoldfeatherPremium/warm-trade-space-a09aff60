...
export default function AdminChatsPage() {
  ...
  const [data, setData] = useState<Awaited<ReturnType<typeof adminListConversations>> | null>(null);
  ...
  useEffect(() => {
    ...
    setIsLoading(true);
    const load = () =>
      adminListConversations({ q: q || undefined, flaggedOnly, limit: 80 })
        .then((d) => {
          if (alive) {
            setData(d);
            setIsLoading(false);
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2 text-[10px] text-muted-foreground mt-1">
                  {c.order_no && (
                    <Link
                      href={`/orders/${c.order_id as string}`}
